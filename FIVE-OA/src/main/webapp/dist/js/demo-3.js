(function() {
	...
	function Triangle() {
		...
		function init() {
			_this.pos.x = width * 0.49;
			_this.pos.y = height*1.2;
			_this.coords[0].x = -10 + Math.random() *50;
			_this.coords[0].y = -10 + Math.random() * 50;
			_this.coords[1].x = -10 + Math.random() * 50;
			_this.coords[1].y = -10 + Math.random() * 50;
			_this.coords[2].x = -10 + Math.random() * 50;
			_this.coords[2].y = -10 + Math.random() * 50;
